...
import { myCpfValidation } from "../src/domain/entities/CpfValidator";
...
test("Deve testar se é o meu cpf", function () {
	const isMyCpf = myCpfValidation("055.072.419-29");
	expect(isMyCpf).toBeTruthy();
});